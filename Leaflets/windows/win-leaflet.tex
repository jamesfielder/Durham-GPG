...
\title{\textit{GNU Privacy Guard}: \\A CompSoc guide to daily use of email encryption\\\vskip1em Windows Edition}
\author{%
  Martin Dehnel\\
  James Fielder\\ 
  (Durham University)\\
